Инструкция по установке и запуску Электронной библиотеки Шаг 1: Клонирование репозитория Откройте терминал и выполните команду, чтобы клонировать репозиторий на ваш компьютер:
